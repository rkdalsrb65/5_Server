...
public class loginServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		/* POST방식은 문자 데이터가 깨질 위험이 있기 때문에
		요청 정보에 담긴 데이터의 문자 인코딩을 UTF-8로 변경한다 */
...
//		
//		out.println("<body>");
//		out.println("<h1 style='color:#ccffff;'>로그인 결과</h1>");
//		out.printf("<h3 style='color:#ccff99;'> %s </h3>", result);
//		
