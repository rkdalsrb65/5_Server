...
<body>
    <h1 style='color: #ccccff'>JSTL(Jsp Standard Tag Library)</h1>
    ...
    <h3 style='color: orange'>JSTL 라이브러리 등록 방법</h3>
    <ol>
    ...
    <h3 style='color: orange'>JSTL 사용을 위한 선언 방법</h3>
	...
	<h1 style='color: #ccccff'>1. 변수 선언 ( c:set 태그 )</h1>
	...
	<h1 style='color: #ccccff'>2. 변수 삭제 ( c:remove )</h1>
	...
	<h1 style='color: #ccccff'>3. 조건문 - if ( c:if 태그 )</h1>
	...
	<h1 style='color: #ccccff'>4. 조건문 - if ~ else if ~ else ( c:choose, c:when, c:otherwise )</h1>
	
	<pre>
				c:choose		: when, otherwise를 감싸는 태그
									(현재 태그 내부에 if ~ else ~ else 를 작성하겠다)
	...
	<h1 style='color: #ccccff'>5. 반복문 ( c:forEach 태그 )</h1>
	...
	<h3 style='color: orange'>일반 for문 형식으로 사용</h3>
	...
	<h3 style='color: orange'>일반 for문 + varStatus</h3>
