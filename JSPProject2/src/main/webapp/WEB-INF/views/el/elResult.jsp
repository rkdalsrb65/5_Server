...
<body>
    ...
    <h3 style='color: #ccccff'>EL을 이용해서 출력하기</h3>

    <h4 style='color: orange'>파라미터</h4>
    <pre>
    ...
    <h4 style='color: orange'>추가 세팅된 값</h4>
    <pre>
        \${ 세팅한 key 값 }
    ...
    <h3 style='color: #ccccff'>EL에서 null과 '비어있다'에 대한 처리 방법</h3>
    <%-- null : 참조 X
    비어있다 : 객체는 존재하는 내용(요소)이 없다
    --%>

    <h4 style='color: orange'>empty : 비어있거나 null인지를 검사하는 연산자</h4>

    <h4 style='color: orange'>\${ 값 == null} / \${ 값 eq null} : null 인지 검사하는 방법</h4>

    <h4 style='color: orange'>\${ 값 != null} / \${ 값 eq null} : null 아닌지 검사하는 방법</h4>
