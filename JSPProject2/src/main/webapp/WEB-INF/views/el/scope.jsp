...
<body>
    <h1 style='color: #ccccff'>Servlet/JSP 내장 객체와 범위(scope)</h1>
    ...
    <h1 style='color: #ccccff'>우선 순위 확인 : ${str}</h1>

    <h3 style='color: blue'>page의 str 값 : ${pageScope.str}</h3>
    <h3 style='color: blue'>request의 str 값 : ${requestScope.str}</h3>
    <h3 style='color: blue'>session의 str 값 : ${sessionScope.str}</h3>
    <h3 style='color: blue'>application의 str 값 : ${applicationScope.str}</h3>
